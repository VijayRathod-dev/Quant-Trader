...
class StockResearchSystem:
    def __init__(self, bright_data_api_token: str, gemini_api_key: str):
    ...
    async def initialize(self):
        ...
        self.supervisor = create_supervisor(
            model=init_chat_model(model="gemini:gemini-2.5-flash", api_key=self.gemini_api_key),
...
print("StockResearchSystem module loaded.")